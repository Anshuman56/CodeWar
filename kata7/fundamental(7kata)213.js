...
function findEmployeesRole(name) {
  ...
  let employe = employees.filter(item => item.firstName === fName && item.lastName === lName);
  return employe.length === 0? 'Does not work here!': employe[0].role// Passed employees role
}