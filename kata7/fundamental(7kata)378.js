...
//enter code here
  let a = a1.filter(item => typeof item === 'number')[0];
  let b = a2.filter(item => typeof item === 'number')[0];
return  a === undefined || b === undefined ? 'Not possible' : a > b ? 'Right': a === b ? 'Same': 'Wrong';
}